          ...
          >
            {ingredientList.map((item) => (
              <div className="flex justify-between items-center px-2 py-1">
                ...
                <button className="text-[13px] text-pink-700 font-semibold bg-pink-100 px-2 py-1 rounded-md transition-all duration-300 ease-out hover:bg-pink-200 hover:text-">Remove</button>
              </div>
            ))}
          </div>
        </div>
