        ...
        <div className="flex items-center justify-between gap-4 flex-col sm:flex-row">
          ...
          <div className="flex gap-3 items-center">
            ...
            <div className="relative">
              ...
              {showChooseTime && (
                <div className="mt-2 w-44 right-0 absolute  rounded shadow-lg p-2 text-sm z-40 text-pink-700 bg-pink-100 transition-all duration-300 ease-in hover:bg-pink-200">
                  <button
                    onClick={handleAll}
