      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mt-6">
          ...
          {/* Dropdown */}
            ...
            <div className={`max-w-3xl mx-auto mt-3 bg-white border-pi rounded shadow p-1 transition-all duration-300 ease-in  ${showDropdown && ingredientList.length > 0 ? 'opacity-100 translate-y-0 visible' : 'opacity-0 -translate-y-2 invisible'}`}>
