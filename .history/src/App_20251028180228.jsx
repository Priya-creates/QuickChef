        ...
        <div className="mt-6">
          ...
          >
            <div className="relative flex-1">
              <input
                className="w-full p-3 rounded-l-md rounded-r-md bg-pink-100/75 border border-pink-100 outline-none text-pink-900 placeholder-pink-900"
                type="text"
                name="ingredient"
          ...
          <div className="max-w-3xl mx-auto mt-2">
            ...
            {message && !loading && (
              <div className="text-sm text-gray mt-1">{message}</div>
            )}
          </div>
