          ...
          <div className="flex gap-3 items-center">
            ...
            <div className="relative">
              ...
              >
                ...
                <div className={`mt-2 w-44 right-0 absolute  rounded shadow-lg p-2 text-sm z-40 text-pink-700 bg-pink-100 transition-all duration-300 ease-in  ${showChooseTime ? 'opacity-100 translate-y-0 visible' : 'opacity-0 -translate-y-2 invisible'}` `}>
                  <button
                    onClick={handleAll}
